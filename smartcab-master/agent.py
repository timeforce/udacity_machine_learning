...
class LearningAgent(Agent):
    ...
    def build_state(self):
        ...
        # select 5 features and state is the combination of values of all 5 features. The total number is 384.
    ...
    def learn(self, state, action, reward):
        ...
        # Show the current learning progress, including state coverage and state-action coverage
